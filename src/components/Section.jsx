...
return (
    <div className="flex flex-col gap-8 mt-5 w-full">
        <div className="flex flex-col gap-4 text-center">
            <h1 className="font-[RobotoCondensed-Bold] text-4xl">¿Cómo jugar?</h1>
            <p className="font-[RobotoCondensed-Regular] text-2xl">Crae posee una modalidad de juego definidas <br /> pero siempre apoyamos la creatividad y que <br /> crees tus propias reglas y modalidades.</p>
        </div>
        <div className="flex flex-col gap-5 justify-center items-center">
            <div className="flex items-center text-start gap-5">
                <TbCircleNumber1Filled className="text-8xl" />
                <p className="font-[RobotoCondensed-Regular]">Uno de los jugadores hace de “creativo” en cada uno de los turnos. <br /> Observa sus 6 cartas de la mano y, de una de ellas, debe construir <br /> una frase, palabra o sonido y decirla en voz alta (sin mostrar la <br /> carta a los otros jugadores). La frase puede ser inventada o puede <br /> estar inspirada en la poesía, literatura, cine, etc. 
                </p>
                <img src={Card} alt="1" />
            </div>
            <div className="flex items-center text-start gap-5">
                <TbCircleNumber2Filled className="text-8xl" />
                <p className="font-[RobotoCondensed-Regular]">Comenzamos el juego de izquierda a derecha. Selecciona una carta <br /> que inspire tu frase y dila en voz alta. El resto de jugadores <br /> seleccionará de entre sus cartas la que mejor se adapte a la frase <br /> construida por el creativo.
                </p>
                <img src={Card1} alt="1" />
            </div>
            <div className="flex items-center text-start gap-5">
                <TbCircleNumber3Filled className="text-8xl" />
                <p className="font-[RobotoCondensed-Regular]">El objetivo de los jugadores es adivinar cuál de las cartas es la que <br /> el creativo usó para construir su frase. Cada jugador vota de forma <br /> secreta la carta que cree que pertenece al creativo. Para ello,<br /> coloca boca abajo frente a él un objeto que hayas escogido <br /> previamente. 
                </p>
                <img src={Card2} alt="1" />
            </div>
            <div className="flex items-center text-start gap-5">
                <TbCircleNumber4Filled className="text-8xl" />
                <p className="font-[RobotoCondensed-Regular]">- Si todos los jugadores aciertan la carta del creativo, todos los <br /> jugadores excepto el creativo ganan 2 puntos. <br /> 
            ...
            <div className="flex items-center text-start gap-5">
                ...
                <p className="font-[RobotoCondensed-Regular]">Cada jugador roba cartas hasta tener 6 en su mano. El juego <br /> termina cuando se roba la última carta. El jugador que más lejos <br /> haya llegado en la escala de puntuación es el ganador.
                </p>
                <img src={Card4} alt="1" />
            </div>
        </div>
